...
class RandomForest(AbstractModel):
    ...
    def __init__(self):
        ...
        self.model = joblib.load(
            project_root / "files" / "random_forest" / "random_forest.joblib"
        )
        self.feature_scaler = joblib.load(
            project_root / "files" / "random_forest" / "feature_scaler.joblib"
        )
        self.pca_transformer = joblib.load(
            project_root / "files" / "random_forest" / "pca_transformer.joblib"
        )
